            ...
            <div id="sidebar" class="sidebar sidebar-with-footer">
                ...
                <div class="app-brand">
                    <a href="/index.html">
                        ...
                        <span class="brand-name">DemoEcommerce</span>
                    </a>
                </div>
                ...
                <div class="sidebar-left" data-simplebar style="height: 100%;">
                    ...
                    <ul class="nav sidebar-inner" id="sidebar-menu">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="collapse" id="email" data-parent="#sidebar-menu">
                                <div class="sub-menu">
                                    ...
                                    <li>
                                        <a class="sidenav-item-link" href="{{route('categorylist.categorylist')}}">
                        ...
                        <li class="has-sub">
                            <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse"
                                data-target="#product" aria-expanded="false" aria-controls="email">
                        ...
                        <li  class="has-sub" >
                            ...
                            <ul  class="collapse"  id="authentication"
                              ...
                              <div class="sub-menu">
                                    <li >
                                      <a class="sidenav-item-link" href="{{route('logout.logout')}}">
                                                ...
                                                <div class="media media-sm bg-warning-10 p-4 mb-0">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="user-profile.html">
                                                            ...
                                                            @endphp
                                                            <span class="title mb-0">{{$auth->name}}</span>
                            ...
                            <li class="dropdown user-menu">
                                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    {{-- <img src="images/user/user-xs-01.jpg" class="user-image rounded-circle"
                                        alt="User Image" /> --}}
                                    <span class="d-none d-lg-inline-block">{{$auth->name}}</span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li class="dropdown-footer">
                                        <a class="dropdown-link-item" href="{{route('logout.logout')}}"> <i
                                                class="mdi-logout"></i> Logout </a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
